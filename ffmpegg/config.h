...
#define FFMPEG_CONFIGURATION "--enable-nonfree --enable-gpl --enable-libfdk-aac --enable-libmp3lame --enable-libx264 --enable-libx265 --enable-filter=delogo --enable-libopus --enable-libvorbis --enable-libvpx --enable-shared --enable-pthreads --enable-version3 --enable-hardcoded-tables --host-cflags= --host-ldflags= --enable-ffplay"
